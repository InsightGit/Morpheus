...
morpheus::nds::NdsMainLoop::NdsMainLoop() :
    ...
    m_sub_blending_controller = std::make_unique<gfx::NdsBlendingController>(true);
    m_sub_mosaic_controller = std::make_unique<gfx::NdsMosaicController>(true);
